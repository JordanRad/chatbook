...
// path set to call the "auth" service "refreshToken" endpoint
func (c *Client) BuildRefreshTokenRequest(ctx context.Context, v any) (*http.Request, error) {
	...
	if err != nil {
		return nil, goahttp.ErrInvalidURL("auth", "refreshToken", u.String(), err)
	}
	if ctx != nil {
...
func EncodeRefreshTokenRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		...
		if !ok {
			return goahttp.ErrInvalidType("auth", "refreshToken", "*auth.RefreshTokenPayload", v)
		}
		body := NewRefreshTokenRequestBody(p)
		if err := encoder(req).Encode(&body); err != nil {
			return goahttp.ErrEncodingError("auth", "refreshToken", err)
		}
		return nil
	}
}
...
// auth refreshToken endpoint. restoreBody controls whether the response body
...
func DecodeRefreshTokenResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusOK:
			...
			if err != nil {
				return nil, goahttp.ErrDecodingError("auth", "refreshToken", err)
			}
			err = ValidateRefreshTokenResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("auth", "refreshToken", err)
			}
			res := NewRefreshTokenLoginResponseOK(&body)
			return res, nil
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("auth", "refreshToken", resp.StatusCode, string(body))
		}
	}
}
...
//   - "WrongCredentials" (type *goa.ServiceError): http.StatusNotFound
...
func DecodeLoginResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusNotFound:
			...
			err = ValidateLoginWrongCredentialsResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("auth", "login", err)
			}
			return nil, NewLoginWrongCredentials(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
